  ...
  const addOrUpdateEvent = async () => {
    ...
    const eventData: Event = {
      ...
      repeat: {
        ...
        endDate: repeatEndCondition === "날짜" ? repeatEndDate : undefined,
        endCnt: repeatEndCondition === "횟수" ? repeatEndCnt : undefined,
      },
      notificationTime,
    };
          ...
          {isRepeating && (
            <VStack width="100%">
              <FormControl>
                ...
                >
                  <option value="none">유형을 선택해 주세요</option>
              ...
              <HStack width="100%">
                ...
                <FormControl>
                  ...
                  <Select
                    data-cy="repeatEndCondition"
                    value={repeatEndCondition}
                    onChange={(e) => setRepeatEndCondition(e.target.value)}
                  >
                    <option value="">종료 조건 선택</option>
                    {repeatEndCond.map((cond) => (
                ...
                {repeatEndCondition === "날짜" ? (
                  <FormControl>
                    <FormLabel>반복 종료일</FormLabel>
                    <Input
                      data-cy="repeatEndDate"
                      type="date"
                      value={repeatEndDate}
                      onChange={(e) => setRepeatEndDate(e.target.value)}
                    />
                  </FormControl>
                ) : repeatEndCondition === "횟수" ? (
                  <FormControl>
                    <FormLabel>반복 횟수</FormLabel>
                    <Input
                      data-cy="repeatEndCnt"
                      type="number"
                      value={repeatEndCnt}
                      onChange={(e) => setRepeatEndCnt(Number(e.target.value))}
                      min={1}
                    />
                  </FormControl>
                ) : (
          ...
          {filteredEvents.length === 0 ? (
            ...
            filteredEvents.map((event) => (
              <Box
                ...
                width="100%"
              >
                <HStack data-cy="event-card" justifyContent="space-between">
                  <VStack align="start">
                    <HStack>
